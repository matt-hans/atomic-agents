...
For deep material (async/streaming fixtures, honest-test patterns, Instructor test helpers), the authority is `../references/testing.md`. This skill is the action-oriented path: scaffold → mock → assert.
...
- **`/atomic-framework` command**: questions about Atomic Agents in general, or work other than authoring tests.
...
For deeper material — async/streaming fixtures, Instructor test helpers, honest-test patterns — load `../references/testing.md`.
